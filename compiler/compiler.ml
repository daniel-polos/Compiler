...
let reader str = read_sexprs str;;
let tag str = tag_parse_expressions (read_sexprs str);;
let sem str = List.map run_semantics (tag_parse_expressions (read_sexprs str));;
